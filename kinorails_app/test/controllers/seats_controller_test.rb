...
class SeatsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create seat" do
    assert_difference('Seat.count') do
      post seats_url, params: { seat: { pos_x: @seat.pos_x, pos_y: @seat.pos_y, room_id: @seat.room_id } }
    end
  ...
  test "should update seat" do
    patch seat_url(@seat), params: { seat: { pos_x: @seat.pos_x, pos_y: @seat.pos_y, room_id: @seat.room_id } }
