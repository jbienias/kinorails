...
class ScreeningsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create screening" do
    assert_difference('Screening.count') do
      post screenings_url, params: { screening: { date: @screening.date, movie_id: @screening.movie_id, room_id: @screening.room_id } }
    end
  ...
  test "should update screening" do
    patch screening_url(@screening), params: { screening: { date: @screening.date, movie_id: @screening.movie_id, room_id: @screening.room_id } }
